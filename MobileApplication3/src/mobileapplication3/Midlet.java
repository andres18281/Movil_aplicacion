...
public class Midlet extends MIDlet implements CommandListener {
   ...
   public TextField item,cantidad_pares;
   constructor objeto;
  ...
  // public ImageItem imagen;
   ...
   public void pantalla_hombre(){
            ...
            cantidad_pares = new TextField("Cantidad de pares","",3,TextField.NUMERIC);
            f2 = new Form("Hombre...");
    ...
    public void pantalla_niño(){
     ...
     public void addRecord(int item,int talla,int cant_pares,String color,String marca,String tipo_calzado,String tipo_persona){
        ...
        try{
            ...
            dos.writeInt(item);
            dos.writeInt(talla);
            dos.writeInt(cant_pares);
            dos.writeUTF(color);
            dos.writeUTF(marca);
            dos.writeUTF(tipo_calzado);
            dos.writeUTF(tipo_persona);
            dos.flush();
     ...
     //http://developer.nokia.com/Community/Wiki/Create_more_flexible_table_in_Java_ME
